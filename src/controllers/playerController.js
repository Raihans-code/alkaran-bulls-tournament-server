...
export const assignToTeam = asyncHandler(async (req, res) => ok(res, await players.assignPlayerToTeam(req.user, req.params.id, req.body)));
export const removeFromTeam = asyncHandler(async (req, res) => ok(res, await players.removePlayerFromTeam(req.user, req.params.id)));
